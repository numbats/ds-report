...
The project was conducted in three main phases. The first phase is data collection (@sec-unidata & @sec-empdata). Phase two is exploratory data analysis on the university data (@sec-unit-analysis) and on employer data (@sec-job-analysis). Phase three is topic modelling (@sec-unitopic & @sec-emptopic) where we built our own text corpus and group words from the data sets in attempt to find more meaningful results.
