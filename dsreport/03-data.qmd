...
In order to explore the Data Science degrees around Australia Universities, we compiled a list of universities in Australia and the Data Science or related degrees they offered, then web scrapeed required information from each university's website using R. The initial goal was to collect data from all universities in Australia including both undergraduate and postgraduate courses, however, due to time constrain, the data collected only contains Master of Data Science courses from the Group of Eight (Go8) universities.
