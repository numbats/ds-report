...
The initial code to build the LDA model was provided by Professor Tanaka, we have tested using different values for parameter `ntopics` and tried out training the LDA models with different combinations of data. 
